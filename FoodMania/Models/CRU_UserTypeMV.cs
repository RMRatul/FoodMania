...
namespace FoodMania.Models
{
    public class CRU_UserTypeMV
    {
        public CRU_UserTypeMV()
        {
            ...
            foreach (var usertype in new FoodManiaEntities().UserTypeTables.ToList())
            {
        ...
        public CRU_UserTypeMV(int? id)
        {
            ...
            var editusertype = new FoodManiaEntities().UserTypeTables.Where(u => u.UserTypeID == id).FirstOrDefault();
